...
4. One sentence: what is the most expensive mistake a learner could make this week, and how does the teardown gate prevent it? (Answer: leaving a `dev` environment with NAT/compute billing overnight; the gate forces a verified-empty check before the week is marked done.)
