...
*Teardown is part of the work, not an afterthought. A `dev` environment left billing overnight is the most common way learners burn the free trial. The gate exists for a reason — run it.*
